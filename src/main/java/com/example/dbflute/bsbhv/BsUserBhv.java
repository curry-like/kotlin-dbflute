...
public abstract class BsUserBhv extends AbstractBehaviorWritable<User, UserCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<User> selectByPK(String userName) {
        return facadeSelectByPK(userName);
    }

    protected OptionalEntity<User> facadeSelectByPK(String userName) {
        return doSelectOptionalByPK(userName, typeOfSelectedEntity());
    }

    protected <ENTITY extends User> ENTITY doSelectByPK(String userName, Class<? extends ENTITY> tp) {
        return doSelectEntity(xprepareCBAsPK(userName), tp);
    }

    protected <ENTITY extends User> OptionalEntity<ENTITY> doSelectOptionalByPK(String userName, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectByPK(userName, tp), userName);
    }

    protected UserCB xprepareCBAsPK(String userName) {
        assertObjectNotNull("userName", userName);
        return newConditionBean().acceptPK(userName);
    }
    ...
    //                                                                   =================
    /**
     * Pull out the list of referrer-as-one table 'Customer'.
     * @param userList The list of user. (NotNull, EmptyAllowed)
     * @return The list of referrer-as-one table. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<Customer> pulloutCustomerAsOne(List<User> userList)
    { return helpPulloutInternally(userList, "customerAsOne"); }

    // ===================================================================================
    //                                                                      Extract Column
    //                                                                      ==============
    /**
     * Extract the value list of (single) primary key userName.
     * @param userList The list of user. (NotNull, EmptyAllowed)
