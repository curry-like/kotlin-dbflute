...
public class BsUserCB extends AbstractConditionBean {
     ...
     * @param userName : PK, NotNull, VARCHAR(45). (NotNull)
     * @return this. (NotNull)
     */
    public UserCB acceptPK(String userName) {
    ...
    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_UserName_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_UserName_Desc();
        return this;
    }
    ...
    //                                                                         SetupSelect
    //                                                                         ===========
    protected CustomerNss _nssCustomerAsOne;
    public CustomerNss xdfgetNssCustomerAsOne() {
        if (_nssCustomerAsOne == null) { _nssCustomerAsOne = new CustomerNss(null); }
        return _nssCustomerAsOne;
    }
    /**
     ...
     *     <span style="color: #553000">cb</span>.<span style="color: #CC4747">setupSelect_CustomerAsOne(${dynamicFixedConditionVariables})</span>; <span style="color: #3F7E5E">// ...().with[nested-relation]()</span>
     ...
     *     ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getCustomerAsOne()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    public CustomerNss setupSelect_CustomerAsOne() {
        assertSetupSelectPurpose("customerAsOne");
        doSetupSelect(() -> query().queryCustomerAsOne());
        if (_nssCustomerAsOne == null || !_nssCustomerAsOne.hasConditionQuery())
        { _nssCustomerAsOne = new CustomerNss(query().queryCustomerAsOne()); }
        return _nssCustomerAsOne;
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<UserCQ> {
        protected CustomerCB.HpSpecification _customerAsOne;
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnEncodedPassword() { return doColumn("encoded_password"); }
         ...
         */
        public CustomerCB.HpSpecification specifyCustomerAsOne() {
            assertRelation("customerAsOne");
            if (_customerAsOne == null) {
                _customerAsOne = new CustomerCB.HpSpecification(_baseCB
                    , xcreateSpQyCall(() -> _qyCall.has() && _qyCall.qy().hasConditionQueryCustomerAsOne()
                                    , () -> _qyCall.qy().queryCustomerAsOne())
                    , _purpose, _dbmetaProvider, xgetSDRFnFc());
                if (xhasSyncQyCall()) { // inherits it
                    _customerAsOne.xsetSyncQyCall(xcreateSpQyCall(
                        () -> xsyncQyCall().has() && xsyncQyCall().qy().hasConditionQueryCustomerAsOne()
                      , () -> xsyncQyCall().qy().queryCustomerAsOne()));
                }
            }
