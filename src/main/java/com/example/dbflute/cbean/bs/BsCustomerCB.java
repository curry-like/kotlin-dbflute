...
public class BsCustomerCB extends AbstractConditionBean {
     ...
     * @return this. (NotNull)
     */
    public CustomerCB acceptUniqueOf(String userName) {
     ...
     *     ... = <span style="color: #553000">customer</span>.<span style="color: #CC4747">getUser()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<CustomerCQ> {
        ...
        protected void doSpecifyRequiredColumn() {
            ...
            if (qyCall().qy().hasConditionQueryUser()
                ...
                columnUserName(); // FK or one-to-one referrer
            }
        }
        @Override
