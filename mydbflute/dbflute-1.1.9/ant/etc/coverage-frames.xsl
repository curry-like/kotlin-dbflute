...
<!--
 ...
 of a reference classpath so that you have the findAll of classes/methods
...
<!--
 detailed info for a package. It will output the findAll of classes
...
<xsl:template match="package" mode="write">
    ...
    <!-- create a classes-findAll.html in the package directory -->
...
<!-- findAll of classes in a package -->
